...
const courses = [
  ...
  ['course-patchwork.jpg','PATCHWORK','Patchwork: Do básico ao acabamento','Aprenda fundamentos e detalhes para transformar tecidos em peças para a casa.','/cursos/patchwork-do-basico'],
  ['course-madeira.jpg','ARTE EM MADEIRA','Arte em Madeira: Decore e transforme','Pintura, texturas e acabamentos para criar peças com personalidade.','/cursos/arte-em-madeira'],
  ['course-scrapbook.jpg','SCRAPBOOK','Scrapbook: Memórias que ficam','Papéis, composição e detalhes para transformar histórias em projetos afetivos.','/cursos/scrapbook-memorias'],
];
const posts = [
  ['blog-cestinho.jpg','PASSO A PASSO','Cestinho de tecido: passo a passo completo','Do material ao acabamento, uma peça bonita para organizar e decorar a casa.','/blog/cestinho-de-tecido'],
  ['blog-linhas.jpg','DICAS','Como escolher as melhores linhas','Um guia para escolher materiais e deixar cada projeto ainda mais especial.','/blog/como-escolher-linhas'],
  ['blog-madeira.jpg','TÉCNICAS','Pintura em madeira: técnicas e cuidados','Preparação, pintura e proteção para peças feitas para durar.','/blog/pintura-em-madeira'],
