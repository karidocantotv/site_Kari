  ...
  return <>
    ...
    <header className="nav">
      <div className="container nav-inner">
        <Link href="/" className="logo logo-mark" aria-label="KARI Do Canto — início"><img src="/brand/kari-do-canto.png" alt="KARI Do Canto — Artesanato com Afeto" /></Link>
...
function Footer() {
  return <>
    ...
    <footer className="footer"><div className="container footer-grid">
      <div><Link href="/" className="logo logo-footer" aria-label="KARI Do Canto — início"><img src="/brand/kari-do-canto.png" alt="KARI Do Canto — Artesanato com Afeto" /></Link><p>Artesanato, criatividade e aprendizado para você criar com as próprias mãos.</p></div>
